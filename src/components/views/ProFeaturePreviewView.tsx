...
const PRO_CARDS: FeatureCardData[] = [
  {
    icon: '🎨',
...
export const ProFeaturePreviewView: React.FC<ProFeaturePreviewViewProps> = () => {
      ...
      <div className="bg-white p-6 sm:p-8 rounded-3xl border border-stone-200/90 shadow-sm space-y-6">
        <div className="border-b border-stone-100 pb-4">
          ...
          <h3 className="text-xl sm:text-2xl font-extrabold text-stone-900 tracking-tight">
            Keunggulan Laboratorium Aksa AI Pro
          </h3>
        ...
        <div className="p-4 sm:p-5 rounded-2xl bg-emerald-50/70 border border-emerald-200/80 space-y-2 text-xs sm:text-sm text-emerald-950 font-medium">
          <div className="flex items-center gap-2 font-bold text-emerald-900 text-sm">
            <CheckCircle2 className="w-4 h-4 text-emerald-700 shrink-0" />
            <span>Jaminan Kompatibilitas Fitur</span>
          </div>
          <div className="space-y-1 pl-6 text-emerald-900/90 text-xs sm:text-sm">
            <p className="flex items-center gap-2">
              <span className="font-bold text-emerald-700">✓</span>
              <span>Semua fitur Basic tetap berjalan.</span>
            </p>
            <p className="flex items-center gap-2">
              <span className="font-bold text-emerald-700">✓</span>
              <span>Upgrade hanya menambahkan kemampuan baru.</span>
            </p>
          </div>
        </div>
        ...
        <div className="pt-2 text-center">
          ...
          >
            ...
            <span>Pelajari SekolahHub Pro</span>
          </button>
        </div>
      </div>

      {/* Dialog Modal when button is clicked */}
      {isModalOpen && (
